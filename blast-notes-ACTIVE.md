...
```
This folder contains 61 short-read genomes of North American Thamnophiini species of snakes. These genomes come from the HAL file posterior to CACTUS alignment. 
